...
class ExpertDetailState {
  ...
  const ExpertDetailState({this.expert, this.isLoading = false, this.error});
...
class ExpertDetailNotifier extends StateNotifier<ExpertDetailState> {
  ...
  ExpertDetailNotifier({required this.repository, required this.expertId})
  ...
  Future<void> loadExpertDetail() async {
    ...
    try {
      ...
      state = state.copyWith(expert: expert, isLoading: false);
    } catch (e) {
