...
class RescuerCatchingHistoryScreen extends ConsumerStatefulWidget {
  const RescuerCatchingHistoryScreen({super.key});

  @override
  ConsumerState<RescuerCatchingHistoryScreen> createState() =>
      RescuerCatchingHistoryScreenState();
}

class RescuerCatchingHistoryScreenState
    extends ConsumerState<RescuerCatchingHistoryScreen> {
